package andro.pluginsuite.ui.component
                ...
                Box(
                    ...
                    Row(
                        ...
                        Text(
                            ...
                            text = stringResource(andro.pluginsuite.core.R.string.loading),
                        )
                    }
                }
            }
...
fun MarkdownTextAsync(getMarkdownText: suspend () -> String) {
    ...
    when {
        error -> Text(stringResource(andro.pluginsuite.core.R.string.download_file_error))
