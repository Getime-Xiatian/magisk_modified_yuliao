...
import andro.pluginsuite.ui.MainActivity
import andro.pluginsuite.ui.component.LoadingDialogHandle
import andro.pluginsuite.ui.component.MarkdownTextAsync
import andro.pluginsuite.ui.component.rememberLoadingDialog
import andro.pluginsuite.ui.flash.FlashUtils
import andro.pluginsuite.ui.install.InstallBottomSheet
...
private fun EnvFixComposableDialog(
    ...
    val needsFullFix = code == 2 ||
        Info.env.versionCode != andro.pluginsuite.core.BuildConfig.APP_VERSION_CODE ||
        Info.env.versionString != andro.pluginsuite.core.BuildConfig.APP_VERSION_NAME
