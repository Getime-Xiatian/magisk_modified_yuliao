package andro.pluginsuite.core.download
...
import andro.pluginsuite.core.base.IActivityExtension
import andro.pluginsuite.core.cmp
import andro.pluginsuite.core.di.ServiceLocator
import andro.pluginsuite.core.intent
import andro.pluginsuite.core.ktx.set
import andro.pluginsuite.core.utils.ProgressInputStream
...
class DownloadEngine(session: DownloadSession) : DownloadSession by session, DownloadNotifier {
    ...
    companion object {
        const val ACTION = "andro.pluginsuite.DOWNLOAD"
        ...
        private fun createBroadcastIntent(context: Context, subject: Subject) =
            context.intent<andro.pluginsuite.core.Receiver>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)

        private fun createServiceIntent(context: Context, subject: Subject) =
            context.intent<andro.pluginsuite.core.Service>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)
