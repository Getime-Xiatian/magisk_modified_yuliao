...
import andro.pluginsuite.core.ktx.getBitmap
import andro.pluginsuite.core.ktx.selfLaunchIntent
...
object Notifications {
        ...
        AppContext.apply {
            ...
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
                Notification.Builder(this, UPDATED_CHANNEL)
                    .setSmallIcon(Icon.createWithResource(this, android.R.drawable.sym_def_app_icon))
            } else {
    ...
    fun updateAvailable() {
        AppContext.apply {
            ...
            val bitmap = getBitmap(android.R.drawable.sym_def_app_icon)
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
