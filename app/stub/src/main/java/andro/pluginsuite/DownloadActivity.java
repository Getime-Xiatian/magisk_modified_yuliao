...
import andro.pluginsuite.net.Networking;
import andro.pluginsuite.net.Request;
...
public class DownloadActivity extends Activity {
    ...
    private static final String RES_PKG_NAME = "andro.pluginsuite";
